...
<center><body>
    ...
    <form action="my_work_in_PHP.php" method="POST" >
        <input type="submit" name="value" class="text" id="sonne" value='midorima'>
    </form>
    <p><span><p><h2 id="change" class="text">Akashi Seiguro</h2></p></span></p>
 ...
 <h3 align="right" ><P><MARQUEE scrollDelay=28 behavior=alternate bgCOlor="0000" height=66><font class="text">это моя любимая песенка</font></MARQUEE></B></FONT face=Arial size=4></P></h3>
 <p><U><MARQUEE>Привет! Это моя первая страничка!</MARQUEE></U></p>
    ...
    <script>
      let button=document.getElementById("sonne")
      ...
      function change(event){
        ...
        gif.src="spot.gif"
        changeText.textContent="the spot"
      }
      button.addEventListener(`mouseout`,changeAkashi)
      function changeAkashi(event){
        for (let i=0;texts.length>i;i++){
          texts[i].style.color="#811111"
        }
        for (let i=0;td.length>i;i++){
          td[i].style.borderColor="#811111"
        }
        table.style.borderColor="#811111"
        gif.src="1573302701_akashi runin.gif"
        changeText.textContent="Akashi Seiguro"
      }
    </script>
</body></center>
